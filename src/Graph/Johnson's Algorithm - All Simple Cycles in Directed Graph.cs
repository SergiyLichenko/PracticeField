...
namespace GitHub
{
    public class Program
    {
        static void Main()
        {
            var graphAdj = CreateGraph(6);

            var simpleCycles = graphAdj.GetAllSimpleCycles();

            Console.WriteLine("All simple cycles:\n");
            foreach (var cycle in simpleCycles)
        ...
        private static GraphAdj<int> CreateGraph(int n)
        {
            ...
            graphAdj.AddEdge(2, 5);
            graphAdj.AddEdge(3, 4);
            graphAdj.AddEdge(4, 3);
            graphAdj.AddEdge(4, 2);
            graphAdj.AddEdge(5, 4);
    ...
    public class GraphAdj<T>
    {
        ...
        #region Johnson's Algorithm - All Simple Cycles in Directed Graph
